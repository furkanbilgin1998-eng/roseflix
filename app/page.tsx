...
export default async function Home(){
 ...
 return <div>
  ...
  <section className="container-main py-20"><SectionTitle eyebrow="Roseflix Blog" title={<T en="Stories About Cinema" tr="Sinemaya Dair Hikâyeler"/>} link="/blog"/><ArticleCard article={articles[0]} wide/><div className="mt-10 grid gap-8 md:grid-cols-3">{articles.slice(1,4).map(a=><ArticleCard key={a.slug} article={a}/>)}</div></section>
  <Newsletter/>
 </div>
}
